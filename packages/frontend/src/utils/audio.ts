 ...
 * Used for xAI Realtime Voice API WebSocket communication
 */

/**
 * Convert Float32Array to PCM16 and base64 encode
 * Used for sending audio to the xAI Realtime API
 */
 ...
 * Used for receiving audio from the xAI Realtime API
 */
